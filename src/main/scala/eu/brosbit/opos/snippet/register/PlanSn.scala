...
class PlanSn extends BaseTeacher {
  ...
  val plansOfClass = PlansOfClass.findAll(("classId" -> idClass)) match {
    ...
    case _ => {
      ...
      plan.classId = classModel.id.get
  ...
  def showTable() = {
    ...
    if (bells.beginLesson.length < 10) "tr" #> <tr>
      <td>brak ustawionych dzwonków</td>
    </tr>
    else
      "tr" #> (0 to 10).toList.map(i => {
        <tr>
          ...
          <td>
            {"%s - %s".format(bells.beginLesson(i), bells.endLesson(i))}
          </td>
          <td>
            <span class="subject">
              {plansOfClass.day1(i).subject}
            </span>
            <span class="info">
              {plansOfClass.day1(i).info}
            </span>
            <span class="room">
              {plansOfClass.day1(i).room}
            </span>
          </td>
          <td>
            <span class="subject">
              {plansOfClass.day2(i).subject}
            </span>
            <span class="info">
              {plansOfClass.day2(i).info}
            </span>
            <span class="room">
              {plansOfClass.day2(i).room}
            </span>
          </td>
          <td>
            <span class="subject">
              {plansOfClass.day3(i).subject}
            </span>
            <span class="info">
              {plansOfClass.day3(i).info}
            </span>
            <span class="room">
              {plansOfClass.day3(i).room}
            </span>
          </td>
          <td>
            <span class="subject">
              {plansOfClass.day4(i).subject}
            </span>
            <span class="info">
              {plansOfClass.day4(i).info}
            </span>
            <span class="room">
              {plansOfClass.day4(i).room}
            </span>
          </td>
          <td>
            <span class="subject">
              {plansOfClass.day5(i).subject}
            </span>
            <span class="info">
              {plansOfClass.day5(i).info}
            </span>
            <span class="room">
              {plansOfClass.day5(i).room}
            </span>
          </td>
        </tr>
      })
