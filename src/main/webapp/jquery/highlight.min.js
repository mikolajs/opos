...
;hljs.registerLanguage("css",e)})();/*! `typescript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `c` grammar compiled for Highlight.js 11.3.1 */
...
strings:i,keywords:u}}}})();hljs.registerLanguage("c",e)})();/*! `diff` grammar compiled for Highlight.js 11.3.1 */
...
end:/$/}]}}})();hljs.registerLanguage("diff",e)})();/*! `java` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("java",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.3.1 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `cpp` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("markdown",e)})();/*! `scala` grammar compiled for Highlight.js 11.3.1 */
...
begin:"@[A-Za-z]+"}]}}})();hljs.registerLanguage("scala",e)})();/*! `csharp` grammar compiled for Highlight.js 11.3.1 */
