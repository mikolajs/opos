...
class JudgerRunnerSpec extends AnyFlatSpec with Matchers {
  ...
  ConfigLoader.init
  val cdir = new ControlDir(CDD.id, CDD.cppFile, CDD.cpp, CDD.dataFile)
  val cdirPython = new ControlDir("34567898", CDD.pyFile, "py", CDD.dataFile)
